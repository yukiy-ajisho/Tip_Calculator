-- Migration: Create calculate_tips function (v3)
-- Execute this in Supabase SQL Editor
-- This function calculates tip distribution for employees based on working hours and tip payments
-- Version 3: 
--   - Fixed trainee-only distribution (when non-trainees are absent, trainees receive full amount)
--   - Groups results by date (employee x date)
--   - Directly inserts results into tip_calculation_results table
--   - Updates tip_calculations status
...
Version 3: 
  - Fixed trainee-only distribution - when non-trainees are absent, trainees receive full amount equally.
  - Groups results by date (employee x date).
  - Directly inserts results into tip_calculation_results table.
  - Updates tip_calculations status (completed/failed).
Returns VOID.';
